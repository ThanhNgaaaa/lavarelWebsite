        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="div_center card coupons">
                    <h2 class="h2_font title">Add product</h2>
                    <form action="{{ url('add_product') }}" class="form frm-add" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="product_image" name="product_image" class="input_file" required=""
                                    type="file">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div>
                            <button type="submit" class="ml-60 btn btn-default">ADD</button>
