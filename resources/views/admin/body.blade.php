              ...
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    ...
                    <p class="text-success ml-2 mb-0 font-weight-medium">customer</p>
                  </div>
                </div>
                <div class="col-3">
                  <div class="icon icon-box-success">
        ...
        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    ...
                    <p class="text-success ml-2 mb-0 font-weight-medium">order</p>
                  </div>
                </div>
                <div class="col-3">
                  <div class="icon icon-box-success ">
              ...
              <h6 class="text-muted font-weight-normal">Orders Paid</h6>
            </div>
          </div>
        </div>
      </div>
